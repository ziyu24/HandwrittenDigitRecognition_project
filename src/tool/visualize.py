...
def visualize_predictions(model, image_dir, grid_size=None, use_save_model=config_yaml['evl']['use_save_model']):
    """
...
def visualize_confusion_matrix(model, test_data, classes, use_save_model=config_yaml['evl']['use_save_model']):
    """
    公共方法：可视化混淆矩阵
    """
    if use_save_model:
...
def show_test_result(model, test_data, show_number, use_save_model=config_yaml['evl']['use_save_model']):
    """
